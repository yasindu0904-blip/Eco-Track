...
export function MyJoinedCleanupEventsPage({ accessToken, onBack, onOpenEvent }: Props) {
  ...
  return <main className="public-events-shell">
    <header className="event-editor-header"><div><span>MY VOLUNTEERING</span><h1>My joined cleanup events</h1><p>Review commitments, assignments, attendance, and history.</p></div><button className="event-action-button secondary" type="button" onClick={onBack}>Citizen dashboard</button></header>
