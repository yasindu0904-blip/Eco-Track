...
describe("EventParticipantOperations", () => {
  beforeEach(() => {
    vi.mocked(listEventParticipants).mockResolvedValue({
      ...
      sessions: [
        { id: "session-past", sessionDate: "2099-08-31", startTime: "09:00:00", endTime: "12:00:00", status: "COMPLETED", capacity: 10, allocatedCount: 1 },
      ...
      participants: [{ id: "participant-a", status: "JOINED", joinedAt: "2026-08-20T00:00:00.000Z", removedAt: null, volunteer: { id: "user-a", fullName: "Volunteer One", phoneNumber: "+94770000001" }, availableSessionIds: ["session-past", "session-a", "session-b"], allocations: [
        { id: "allocation-past", participantId: "participant-a", sessionId: "session-past", status: "PLANNED", allocatedAt: "2026-08-20T00:00:00.000Z", attendanceMarkedAt: null, notes: null },
  ...
  test("shows attendance for an explicitly completed session even before its scheduled clock time", async () => {
