    ...
    <section className="citizen-discovery">
      <div className="citizen-discovery-intro">
        <div>
          ...
          <p>
            Use your current location to find published cleanup events within a
            distance you choose.
          </p>
        </div>
      ...
      {!search ? (
        <div className="citizen-discovery-empty">
          ...
          <p>
            EcoTrack will only request published cleanup events inside your
            selected radius.
          </p>
        </div>
      ) : !loading && events.length === 0 ? (
        <div className="citizen-discovery-empty">
          <strong>No published cleanup events found</strong>
